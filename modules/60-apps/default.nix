  ...
  options.my.services = {
    ...
    home-assistant = {
      ...
      stateDir = lib.mkOption {
        type = lib.types.str;
        default = "/data/state/home-assistant";
      ...
      mediaDir = lib.mkOption {
        type = lib.types.str;
        default = "/data/state/home-assistant/media";
    ...
    zigbee-stack = {
      ...
      dataDir = lib.mkOption {
        type = lib.types.str;
        default = "/data/state/zigbee2mqtt";
    ...
    paperless = {
      ...
      dataDir = lib.mkOption {
        type = lib.types.str;
        default = "/data/state/paperless/data";
        description = "Data directory.";
      };
      mediaDir = lib.mkOption {
        type = lib.types.str;
        default = "/data/state/paperless/media";
        description = "Media directory.";
      };
      consumptionDir = lib.mkOption {
        type = lib.types.str;
        default = "/data/state/paperless/consume";
