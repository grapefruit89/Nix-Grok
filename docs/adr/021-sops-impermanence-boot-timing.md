# ADR-021: SOPS Boot-Timing mit Impermanence — WITHDRAWN

> **WITHDRAWN** — Entfällt mit [ADR-024: systemd-creds + TPM2](024-systemd-creds-tpm.md) (2026-07-05).
>
...
Da sops-nix durch systemd-creds ersetzt wurde (ADR-024), ist dieses Problem
gegenstandslos. `05-sops.nix` existiert nicht mehr im Repo.

## Siehe auch

- [ADR-024 — systemd-creds + TPM2](024-systemd-creds-tpm.md)
- [ADR-006 — SOPS-Migration (superseded)](006-sops-migration-path.md)
